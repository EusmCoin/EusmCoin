...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "eusmcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "eusmcoind.pid"));
